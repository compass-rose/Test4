...
public class SunActivity extends AppCompatActivity {
    ...
    private void setYAxis(){
        ...
        yAxisLeft.setAxisMaxValue(500); // 设置Y轴最大值
    ...
    private void setData(){
        ...
        LineDataSet lineDataSet1 = new LineDataSet(yVals1, "最高光照度");
        LineDataSet lineDataSet2 = new LineDataSet(yVals2, "平均光照度");
        LineDataSet lineDataSet3 = new LineDataSet(yVals3, "最低光照度");
    ...
    public static void startThisActivity(Activity activity) {
        activity.startActivity(new Intent(activity, SunActivity.class));
    }
    private float[] dataSearch(int date){
        ...
        if(c.moveToFirst()){
            do {
                count ++;
                temp = c.getFloat(c.getColumnIndex("sun"));
                sum += temp;
                if(max < temp){
                    max = temp;
                }
